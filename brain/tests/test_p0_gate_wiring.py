...
from brain.p0_gate_runner import _SCENARIO_RUNNERS, run_p0_gate
from brain.engine import MacBrain, MacBrainConfig
from brain.soul_acceptance import ALL_P0_SCENARIOS, P0GateResult
...
class P0GateCLITests(unittest.TestCase):
    def test_cli_exits_zero_on_pass(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "brain.p0_gate_runner"],
