...
from brain.dialogue import _is_forbidden, natural_fallback
from brain.io import CameraFrame
from brain.models.recognition import DeterministicFaceId, DeterministicSpeakerId
...
class ReasoningAcceptanceTests(unittest.TestCase):
    ...
    def test_dialogue_engine_is_in_mac_brain_not_web(self):
        ...
        from brain.dialogue import DialogueEngine  # noqa: F401
    ...
    def test_cross_modal_voice_plus_face_verifies_identity(self):
        from brain.kgraph import infer_entity_type
