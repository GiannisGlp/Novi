...
from brain.social import RelationshipCategory, Relationships, SocialIntelligence
from brain.storage import DurableMemoryStore
from brain.tests.test_mac_brain import PersonBackend
...
class BrainSocialTests(unittest.TestCase):
    def test_brain_notes_person_relationship_and_emits_social(self):
        camera = __import__("brain.tests.test_mac_brain", fromlist=["FakeCamera"]).FakeCamera()
