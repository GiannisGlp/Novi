...
def run_cross_system_acceptance() -> tuple[CrossSystemTestResult, ...]:
    ...
    from brain.soul_acceptance import CommunicationDecision
    ...
    from brain.memory_hardening import DIRECT_SENSOR, OBSERVED, HardenedMemoryManager
    ...
    from brain.memory_hardening import SIMULATED, SIMULATION, VERIFIED
    sim_admit = mgr.admit(
    ...
    from brain.governance_guard import ActionProposal, GovernanceGuard
    ...
    from brain.multi_speed_runtime import SYSTEM_0, MultiSpeedRuntime
