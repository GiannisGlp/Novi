"""Tests for `MAC_BRAIN/resource_telemetry.py` and its wiring into MacBrain.
...
from MAC_BRAIN.multi_speed_runtime import AutonomyState, ResourceMode
from MAC_BRAIN.resource_telemetry import (
    ResourceSample,
    ResourceTelemetry,
