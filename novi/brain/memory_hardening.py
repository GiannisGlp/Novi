...
# Evidence classes (same as docs/NOVI_NVIDIA_ROBOT_LEARNING_COGNITION_AUTONOMY_RESEARCH.md
# research 18: OBSERVED / INFERRED / PREDICTED / SIMULATED / COUNTERFACTUAL /
# HYPOTHESIZED / VERIFIED; docs/03-cognition evidence vocabulary).
EVIDENCE_CLASSES = frozenset({
    OBSERVED, INFERRED, PREDICTED, SIMULATED, COUNTERFACTUAL, HYPOTHESIZED, VERIFIED,
})
