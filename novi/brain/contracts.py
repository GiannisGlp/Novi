...
REGISTRY_PATH = REPOSITORY_ROOT / "novi" / "contracts" / "registry.json"
# Backward compat: old top-level contracts/ location (pre-consolidation)
_LEGACY_REGISTRY_PATH = REPOSITORY_ROOT / "contracts" / "registry.json"
...
class ContractRegistry:
    ...
    def __init__(self, registry_path: Path | None = None) -> None:
        # Resolve to new location, fallback to legacy for pre-consolidation checkouts
        if registry_path is None:
            registry_path = REGISTRY_PATH if REGISTRY_PATH.exists() else _LEGACY_REGISTRY_PATH
