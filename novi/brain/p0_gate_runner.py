...
def _run_s03(brain: Any) -> ScenarioResult:
    ...
    try:
        ...
        brain.soul = __import__("novi.brain.soul", fromlist=["Soul"]).Soul.from_snapshot(durable_before)
