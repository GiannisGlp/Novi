...
- Available models: `qwen3:32b`, `qwen3:4b`, and `nemotron-3.5-lightning` (NVIDIA's fast 30B-A3B mixture-of-experts); a model `<select>` in the app header switches between them live.
